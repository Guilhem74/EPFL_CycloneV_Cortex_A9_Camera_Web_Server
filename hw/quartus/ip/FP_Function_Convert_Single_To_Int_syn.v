...
// ============================================================
// File Name: FP_Function_Convert_Single_To_Int.v
// Megafunction Name(s):
// 			ALTFP_CONVERT
//
...
//altfp_convert DEVICE_FAMILY="Cyclone V" OPERATION="FLOAT2INT" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=9 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=9 aclr clk_en clock dataa result
...
//altbarrel_shift DEVICE_FAMILY="Cyclone V" PIPELINE=2 SHIFTDIR="LEFT" SHIFTTYPE="LOGICAL" WIDTH=31 WIDTHDIST=5 aclr clk_en clock data distance result
...
module  FP_Function_Convert_Single_To_Int_altbarrel_shift
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	reg	[1:0]	dir_pipe;
	reg	[30:0]	sbit_piper1d;
	reg	[30:0]	sbit_piper2d;
	reg	sel_pipec3r1d;
	reg	sel_pipec4r1d;
	wire  [5:0]  dir_w;
	wire  direction_w;
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) sbit_piper1d <= 31'b0;
		else if  (clk_en == 1'b1)   sbit_piper1d <= smux_w[92:62];
	// synopsys translate_off
	initial
		sbit_piper2d = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) sbit_piper2d <= 31'b0;
		else if  (clk_en == 1'b1)   sbit_piper2d <= smux_w[154:124];
	// synopsys translate_off
	initial
		sel_pipec3r1d = 0;
	// synopsys translate_on
	...
	assign
		...
		direction_w = 1'b0,
		pad_w = {16{1'b0}},
		result = sbit_w[185:155],
		sbit_w = {sbit_piper2d, smux_w[123:93], sbit_piper1d, smux_w[61:0], data},
		sel_w = {sel_pipec4r1d, sel_pipec3r1d, distance[2:0]},
		smux_w = {((({31{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[138:124], pad_w[15:0]}) | ({31{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[154:140]})) | ({31{(~ sel_w[4])}} & sbit_w[154:124])), ((({31{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[115:93], pad_w[7:0]}) | ({31{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[123:101]})) | ({31{(~ sel_w[3])}} & sbit_w[123:93])), ((({31{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[88:62], pad_w[3:0]}) | ({31{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[92:66]})) | ({31{(~ sel_w[2])}} & sbit_w[92:62])), ((({31{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[59:31], pad_w[1:0]}) | ({31{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[61:33]})) | ({31{(~ sel_w[1])}} & sbit_w[61:31])), ((({31{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[29:0], pad_w[0]}) | ({31{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[30:1]})) | ({31{(~ sel_w[0])}} & sbit_w[30:0]))};
endmodule //FP_Function_Convert_Single_To_Int_altbarrel_shift
...
//lpm_add_sub DEVICE_FAMILY="Cyclone V" LPM_DIRECTION="ADD" LPM_WIDTH=5 ONE_INPUT_IS_CONSTANT="YES" dataa datab result
//VERSION_BEGIN 18.1 cbx_cycloneii 2018:09:12:13:04:24:SJ cbx_lpm_add_sub 2018:09:12:13:04:24:SJ cbx_mgl 2018:09:12:13:10:36:SJ cbx_nadder 2018:09:12:13:04:24:SJ cbx_stratix 2018:09:12:13:04:24:SJ cbx_stratixii 2018:09:12:13:04:24:SJ  VERSION_END


//lpm_add_sub DEVICE_FAMILY="Cyclone V" LPM_DIRECTION="ADD" LPM_WIDTH=8 ONE_INPUT_IS_CONSTANT="YES" cout dataa datab result
//VERSION_BEGIN 18.1 cbx_cycloneii 2018:09:12:13:04:24:SJ cbx_lpm_add_sub 2018:09:12:13:04:24:SJ cbx_mgl 2018:09:12:13:10:36:SJ cbx_nadder 2018:09:12:13:04:24:SJ cbx_stratix 2018:09:12:13:04:24:SJ cbx_stratixii 2018:09:12:13:04:24:SJ  VERSION_END


//lpm_add_sub DEVICE_FAMILY="Cyclone V" LPM_DIRECTION="ADD" LPM_WIDTH=4 ONE_INPUT_IS_CONSTANT="YES" cout dataa datab result
//VERSION_BEGIN 18.1 cbx_cycloneii 2018:09:12:13:04:24:SJ cbx_lpm_add_sub 2018:09:12:13:04:24:SJ cbx_mgl 2018:09:12:13:10:36:SJ cbx_nadder 2018:09:12:13:04:24:SJ cbx_stratix 2018:09:12:13:04:24:SJ cbx_stratixii 2018:09:12:13:04:24:SJ  VERSION_END


//lpm_add_sub DEVICE_FAMILY="Cyclone V" LPM_DIRECTION="ADD" LPM_WIDTH=4 ONE_INPUT_IS_CONSTANT="YES" dataa datab result
//VERSION_BEGIN 18.1 cbx_cycloneii 2018:09:12:13:04:24:SJ cbx_lpm_add_sub 2018:09:12:13:04:24:SJ cbx_mgl 2018:09:12:13:10:36:SJ cbx_nadder 2018:09:12:13:04:24:SJ cbx_stratix 2018:09:12:13:04:24:SJ cbx_stratixii 2018:09:12:13:04:24:SJ  VERSION_END
...
//lpm_compare DEVICE_FAMILY="Cyclone V" LPM_REPRESENTATION="UNSIGNED" LPM_WIDTH=8 aeb dataa datab
//VERSION_BEGIN 18.1 cbx_cycloneii 2018:09:12:13:04:24:SJ cbx_lpm_add_sub 2018:09:12:13:04:24:SJ cbx_lpm_compare 2018:09:12:13:04:24:SJ cbx_mgl 2018:09:12:13:10:36:SJ cbx_nadder 2018:09:12:13:04:24:SJ cbx_stratix 2018:09:12:13:04:24:SJ cbx_stratixii 2018:09:12:13:04:24:SJ  VERSION_END
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_Function_Convert_Single_To_Int_cmpr
	( 
	aeb,
	dataa,
...
endmodule //FP_Function_Convert_Single_To_Int_cmpr
...
//lpm_compare DEVICE_FAMILY="Cyclone V" LPM_REPRESENTATION="UNSIGNED" LPM_WIDTH=5 agb dataa datab
//VERSION_BEGIN 18.1 cbx_cycloneii 2018:09:12:13:04:24:SJ cbx_lpm_add_sub 2018:09:12:13:04:24:SJ cbx_lpm_compare 2018:09:12:13:04:24:SJ cbx_mgl 2018:09:12:13:10:36:SJ cbx_nadder 2018:09:12:13:04:24:SJ cbx_stratix 2018:09:12:13:04:24:SJ cbx_stratixii 2018:09:12:13:04:24:SJ  VERSION_END

//synthesis_resources = lut 51 reg 185 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_Function_Convert_Single_To_Int_altfp_convert
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	wire  [30:0]   wire_altbarrel_shift6_result;
	...
	reg	int_or_reg2;
	reg	int_or_reg3;
	reg	[8:0]	integer_result_reg;
	reg	[7:0]	integer_rounded_reg;
	...
	wire	[4:0]	wire_add_sub5_dataa;
	wire	[4:0]	wire_add_sub5_datab;
	wire	[4:0]	wire_add_sub5_result;
	wire	[8:0]	wire_add_sub7_result_int;
	wire	wire_add_sub7_cout;
	wire	[7:0]	wire_add_sub7_dataa;
	wire	[7:0]	wire_add_sub7_datab;
	wire	[7:0]	wire_add_sub7_result;
	wire	[4:0]	wire_add_sub8_result_int;
	wire	wire_add_sub8_cout;
	wire	[3:0]	wire_add_sub8_dataa;
	wire	[3:0]	wire_add_sub8_datab;
	wire	[3:0]	wire_add_sub8_result;
	wire	[3:0]	wire_add_sub9_dataa;
	wire	[3:0]	wire_add_sub9_datab;
	...
	wire	[4:0]	wire_max_shift_compare_dataa;
	wire	[4:0]	wire_max_shift_compare_datab;
	wire  add_1_cout_w;
	wire  add_1_w;
	wire  [8:0]  all_zeroes_w;
	wire  [30:0]  barrel_mantissa_input;
	wire  [6:0]  barrel_zero_padding_w;
	wire  below_limit_exceeders;
	wire  [8:0]  below_limit_integer;
	...
	wire  [8:0]  infinity_value_w;
	wire  int_or1_w;
	wire  [8:0]  integer_output;
	wire  [7:0]  integer_post_round;
	wire  [7:0]  integer_pre_round;
	wire  [8:0]  integer_result;
	wire  [7:0]  integer_rounded;
	wire  [7:0]  integer_rounded_tmp;
	wire  [7:0]  integer_tmp_output;
	wire  [3:0]  inv_add_1_adder1_w;
	wire  [3:0]  inv_add_1_adder2_w;
	wire  [7:0]  inv_integer;
	wire  [30:0]  lbarrel_shift_result_w;
	wire  [7:0]  lbarrel_shift_w;
	wire  lower_limit_selector;
	wire  lowest_integer_selector;
	wire  [7:0]  lowest_integer_value;
	wire  [10:0]  man_bus1;
	wire  [11:0]  man_bus2;
	wire  [10:0]  man_or1;
	wire  man_or1_w;
	...
	wire  sign_input;
	wire  sign_input_w;
	wire  [7:0]  signed_integer;
	wire  sticky_bit_w;
	wire  [21:0]  sticky_bus;
	wire  [21:0]  sticky_or;
	wire  [7:0]  unsigned_integer;
	wire  upper_limit_w;
	wire  zero_input_w;

	FP_Function_Convert_Single_To_Int_altbarrel_shift   altbarrel_shift6
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) integer_result_reg <= 9'b0;
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) integer_rounded_reg <= 8'b0;
	...
	assign
		...
		wire_add_sub5_datab = 5'b00001;
	assign
		wire_add_sub7_result_int = wire_add_sub7_dataa + wire_add_sub7_datab;
	assign
		wire_add_sub7_result = wire_add_sub7_result_int[7:0],
		wire_add_sub7_cout = wire_add_sub7_result_int[8:8];
	assign
		wire_add_sub7_dataa = integer_pre_round,
		wire_add_sub7_datab = 8'b00000001;
	assign
		wire_add_sub8_result_int = wire_add_sub8_dataa + wire_add_sub8_datab;
	assign
		wire_add_sub8_result = wire_add_sub8_result_int[3:0],
		wire_add_sub8_cout = wire_add_sub8_result_int[4:4];
	assign
		wire_add_sub8_dataa = inv_integer[3:0],
		wire_add_sub8_datab = 4'b0001;
	assign
		wire_add_sub9_result = wire_add_sub9_dataa + wire_add_sub9_datab;
	assign
		wire_add_sub9_dataa = inv_integer[7:4],
		wire_add_sub9_datab = 4'b0001;
	...
	FP_Function_Convert_Single_To_Int_cmpr   cmpr2
	( 
	.aeb(wire_cmpr2_aeb),
	...
	assign
		...
		const_bias_value_add_width_res_w = 8'b10000111,
		...
		exceed_limit_integer = (({9{(~ exceed_limit_exceeders)}} & below_limit_integer) | ({9{exceed_limit_exceeders}} & infinity_value_w)),
		...
		infinity_value_w = (({9{(~ sign_input_w)}} & pos_infi_w) | ({9{sign_input_w}} & neg_infi_w)),
		int_or1_w = man_or2[4],
		...
		integer_rounded = (({8{(~ lowest_integer_selector)}} & integer_rounded_tmp) | ({8{lowest_integer_selector}} & lowest_integer_value)),
		integer_rounded_tmp = (({8{(~ add_1_w)}} & integer_pre_round) | ({8{add_1_w}} & integer_post_round)),
		integer_tmp_output = (({8{(~ sign_input_w)}} & unsigned_integer) | ({8{sign_input_w}} & signed_integer)),
		inv_add_1_adder1_w = wire_add_sub8_result,
		inv_add_1_adder2_w = (({4{(~ wire_add_sub8_cout)}} & inv_integer[7:4]) | ({4{wire_add_sub8_cout}} & wire_add_sub9_result)),
		inv_integer = (~ integer_rounded_reg),
		lbarrel_shift_result_w = wire_altbarrel_shift6_result,
		lbarrel_shift_w = lbarrel_shift_result_w[30:23],
...
endmodule //FP_Function_Convert_Single_To_Int_altfp_convert
//VALID FILE
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module FP_Function_Convert_Single_To_Int (
	aclr,
	clk_en,
	clock,
	dataa,
	...
	FP_Function_Convert_Single_To_Int_altfp_convert	FP_Function_Convert_Single_To_Int_altfp_convert_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
