...
# ACDS 18.1 625 win32 2019.06.01.12:26:21
# ----------------------------------------
...
# ----------------------------------------
# If FP_Function_Div is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "FP_Function_Div"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "D:/programmes_dd/applications/quartus_prime_standard_edition/quartus/"
}
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/FP_Function_Div_memoryC0_uid146_invTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/FP_Function_Div_memoryC0_uid147_invTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/FP_Function_Div_memoryC1_uid150_invTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/FP_Function_Div_memoryC1_uid151_invTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/FP_Function_Div_memoryC2_uid154_invTables_lutmem.hex ./
}
...
alias com {
  ...
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FP_Function_Div.vhd"      
}
