...
TOP_LEVEL_NAME="FP_Function_Div"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="D:/programmes_dd/applications/quartus_prime_standard_edition/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/FP_Function_Div_memoryC0_uid146_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/FP_Function_Div_memoryC0_uid147_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/FP_Function_Div_memoryC1_uid150_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/FP_Function_Div_memoryC1_uid151_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/FP_Function_Div_memoryC2_uid154_invTables_lutmem.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FP_Function_Div.vhd"      
fi
