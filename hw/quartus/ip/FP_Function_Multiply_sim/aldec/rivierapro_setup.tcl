...
# ACDS 18.1 625 win32 2019.05.30.16:27:18
# ----------------------------------------
# Auto-generated simulation script rivierapro_setup.tcl
# ----------------------------------------
# This script provides commands to simulate the following IP detected in
# your Quartus project:
#     FP_Function_Multiply
# 
...
# ----------------------------------------
# If FP_Function_Multiply is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "FP_Function_Multiply"
}
...
alias com {
  ...
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FP_Function_Multiply.vhd" 
}
