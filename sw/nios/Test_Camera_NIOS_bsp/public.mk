...
SOPCINFO_FILE := C:/EPFL_CycloneV_Cortex_A9_Camera_Web_Server/hw/quartus/soc_system.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x4001030
SOPC_SYSID_FLAG += --sidp=0x4001030
ELF_PATCH_FLAG  += --sidp 0x4001030

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1558894435
SOPC_SYSID_FLAG += --timestamp=1558894435
ELF_PATCH_FLAG  += --timestamp 1558894435
